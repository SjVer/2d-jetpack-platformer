	...
	def vectormovement(self):
		...
		if self.rect.bottom - self.settings.fpstrans(self.yvector) > self.settings.gr_height:
			...
			if self.walking_right:
				...
				if self.hovering and self.rect.right + self.settings.fpstrans(self.settings.walk_speed) / 3 < 10000000000: #self.settings.screen_width:
					self.x += self.settings.fpstrans(self.settings.walk_speed) / 3

				elif self.rect.right + self.settings.fpstrans(self.settings.walk_speed) < 10000000000: #self.settings.screen_width:
					self.x += self.settings.fpstrans(self.settings.walk_speed)
		...
		if self.rect.left + self.settings.fpstrans(self.xvector) > 0 and self.rect.right + self.settings.fpstrans(self.xvector) < 10000000000: #self.settings.screen_width:
